...
x64: /Release_x64,/Debug_x64
x86: /Release_x86,/Debug_x86
API
...
设置N_generate()函数中一次生成的式子数目，最大为100，默认值为50
row:取值范围1~100
...
div:支持除法
power：支持乘方
其中，不支持单独乘方，如果设置为set_operator(0,0,0,0,1),则会自动加入加法运算
默认支持加减乘除
...
//end 生成参数的设置 
注：以上接口都带有安全检查，如果输入了错误的范围或非法数，则会返回False，说明设置失败
系统将保留上一次设置/默认值（如仍未设置）的参数
